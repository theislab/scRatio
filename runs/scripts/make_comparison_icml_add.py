...
def main(cfg: DictConfig):
    ...
    with open(f"/home/icb/egor.antipov/scFM_density_estimation/notebooks/icml_tests/table_results/results_icml_{cfg.loc}_{cfg.num_dims}_swept2_special.pkl", "wb") as f:
