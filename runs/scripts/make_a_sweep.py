...
def main(cfg: DictConfig):
    ...
    with open(f"/home/icb/egor.antipov/scFM_density_estimation/notebooks/icml_tests/sweep_results/sweep_loc4_{cfg.num_dims}_{cfg.lr}_{cfg.cond_latent_dim}.pkl", "wb") as f:
