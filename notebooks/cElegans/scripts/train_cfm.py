...
def get_cfm_model(n_dims, cond_dims, config):
    sys.path.insert(0, "/home/icb/lorenzo.consoli/repos/scFM_density_estimation/notebooks/cElegans/")
...
@hydra.main(
    config_path="/home/icb/lorenzo.consoli/repos/scFM_density_estimation/notebooks/cElegans/configs/cfm",
